...
const { compare, getNicknameFromGithubLink, getIndexPair } = require('./constants');

const mentorStudentsPairsFile = XLSX.readFile('./assets/data/Mentor-students-pairs.xlsx');
const tasksFile = XLSX.readFile('./assets/data/Tasks.xlsx');
const mentorScoreFile = XLSX.readFile('./assets/data/Mentor-score.xlsx');
...
fs.writeFile('data/data.json', json, 'utf8', () => {
  console.log('Writing is done!'); //eslint-disable-line 
});
